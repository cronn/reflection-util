...
/**
 * Note: You need to enable annotation processing in your IDE to run this class. See
 * https://github.com/artyushov/idea-jmh-plugin/issues/13
 *
 * <p>In IntelliJ: <tt>Preferences -> Build, Execution, Deployment -> Compiler -> Annotation
 * Processors</tt>
 */
