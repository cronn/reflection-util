...
public class DeepImmutableMapTest {
  ...
  void testImmutableMap() {
    ...
    OtherTestEntity valueFromEntrySetIterator =
        immutableMap.entrySet().iterator().next().getValue();
  ...
  void testImmutableMap_ImmutableKey() {
    Map<Date, Object> immutableMap =
        ImmutableProxy.create(Collections.singletonMap(new Date(123L), null));
